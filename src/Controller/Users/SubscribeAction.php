...
use App\Model\User\Application\Command\Subscribe\SubscribeCommand;
use App\Model\User\Application\Command\Subscribe\SubscribeCommandHandler;
use App\Model\User\Application\Command\UnSubscribe\UnSubscribeCommand;
use App\Model\User\Application\Command\UnSubscribe\UnSubscribeCommandHandler;
...
final class SubscribeAction extends AbstractController
{
    ...
    public function subscribe(string $id, SubscribeCommandHandler $handler): Response
    {
        ...
        return $this->redirectToRoute('app_users_show', ['nicknameOrId' => $id]);
    }
